...
const ComponentToolNavbarDarkModeToggle = React.memo(
  (props: IComponentProps) => {
    const toggle = () => props.onChange(!props.checked);

    return (
      <label className="theme-toggle switch" title={props.title ?? "Toggle Dark Mode"}>
      <input
...
export default ComponentToolNavbarDarkModeToggle;
