...
export default class ComponentPagePostAddChooseCategory extends Component<
  IPageProps,
  IPageState
> {
          ...
          <div className="card">
            <div className="card-body">
              <h4 className="text-center">
                {this.props.page.props.t('category')}
              </h4>
        ...
        <div className="row">
          <div className="col-md-10">
            <ComponentFormSelect
              ...
              value={this.props.page.state.categories?.filter((item) =>
                this.props.page.state.formData.categories?.includes(item.value)
              )}
              onChange={(item: any, e) =>
